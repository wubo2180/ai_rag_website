...
class DifyClient:
    ...
    def __init__(self, config_path: str = "config.yaml"):
        ...
        dify_config = self.config['dify']
        self.base_url = os.environ.get('DIFY_BASE_URL', dify_config['base_url'])
        self.api_key = os.environ.get('DIFY_API_KEY', dify_config['api_key'])
        self.default_user = os.environ.get('DIFY_DEFAULT_USER', dify_config['default_user'])
        dify_config['base_url'] = self.base_url
        dify_config['api_key'] = self.api_key
        dify_config['default_user'] = self.default_user
