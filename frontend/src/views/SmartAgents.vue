              ...
              <div class="card-content">
                ...
                <div class="card-stats">
                  <span class="agent-count"
                    >{{ category.count || 0 }} 个智能体</span
                  >
                  <span class="popularity"
                    >⭐ 4.{{ Math.floor(Math.random() * 5) + 5 }}</span
                  >
                </div>
              </div>
      ...
      <div v-else class="agents-grid">
        ...
        >
          ...
          <div class="agent-actions">
            <button class="btn btn-primary" @click.stop="executeAgent(agent)">
              <i class="fas fa-play"></i>
              执行任务
            </button>
            <button class="btn btn-secondary" @click.stop="viewDetails(agent)">
